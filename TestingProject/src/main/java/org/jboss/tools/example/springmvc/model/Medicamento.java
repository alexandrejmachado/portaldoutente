...
@NamedQueries({
	...
	@NamedQuery(name=Medicamento.FIND_BY_ID, query = "SELECT m FROM Medicamento m WHERE m.id = :" + Medicamento.ID)
})
public class Medicamento {
	...
	public static final String FIND_BY_ID = "Medicamento.findById";
